...
The base `team.md` from `/creativestack:setup` looks like this:
...
| `type` | Already set by `/creativestack:setup`; used for language adaptation |
...
This skill **appends** to the existing `learnings.md` (created by `/creativestack:setup`)
