---
name: setup
description: Set up your Brain — who you are, team, tone of voice, clients, and tools. Run once, update anytime. Includes brain health checks and team roster import. Adapts to freelancers, studios, agencies, in-house teams, and creative companies.
---
...
_For a comprehensive starting point, re-run `/creativestack:setup` and pick one of
...
`~/.creativestack/visual-style.md` directly anytime, or re-run `/creativestack:setup`
to switch presets."
...
_No case studies added yet. Use /creativestack:case-study to create them, or add manually._
```
...
_No methodology documented yet. Use /creativestack:post-mortem after completing projects to start capturing how you work._
```
...
_No learnings captured yet. Use /creativestack:post-mortem after completing projects to build this up over time._
```
...
like `/creativestack:status-update`, `/creativestack:project-kickoff`,
`/creativestack:meeting-notes`, `/creativestack:timesheet-summary`, and others to share
...
_No projects tracked yet. Run `/creativestack:project-kickoff` to set one up properly,
or start any project-aware skill (e.g. `/creativestack:status-update`) — it'll offer
...
- **case-studies.md** — empty (populate with /creativestack:case-study)
- **methodology.md** — empty (populate with /creativestack:post-mortem)
- **learnings.md** — empty (populate with /creativestack:post-mortem)
...
of these files directly in a text editor, or re-run `/creativestack:setup` to update
sections.
...
"Updated. {Brief one-line summary of what changed.} Re-run `/creativestack:setup` any
...
- {e.g., "Run /creativestack:case-study to populate case-studies.md — 14 skills reference this file."}
- {e.g., "team.md was last updated 4 months ago — re-run /creativestack:setup with 'Update specific file' → team.md"}

## Skill Chains

After setup or health check, suggest the most relevant next step based on user type:

- If brain is freshly set up → "Run `/creativestack:ai-audit` to get an AI readiness snapshot now that your context is configured."
- If tone-of-voice is sparse → "Run `/creativestack:update-voice` to refine your tone of voice with more detail."
- If case-studies.md is empty → "Run `/creativestack:case-study` to start building your case study library."
- If freelancer and no case studies → "Run `/creativestack:case-study` — it's the single most valuable thing for winning new work."
